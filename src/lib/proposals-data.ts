...
export const proposals: Proposal[] = [
  ...
  },
  {
    ...
    systemPackages: [
      {
        ...
        screens: ["Painel da safra", "Safra e lotes", "Guarda", "Editor da política de guarda", "Corte e blend", "Mapa da adega", "Etiquetas e QR", "Ficha do produtor", "Demonstrativo do produtor"],
        deliverables: [
      ...
      },
      {
        ...
        screens: ["Calendário", "Nova reserva", "Agenda do dia", "A casa agora", "Avisos e lembretes", "Experiências e capacidade", "Pós-visita e conversão"],
        deliverables: [
          "Calendário do mês com os dias cheios, os disponíveis e os que ainda estão vazios",
          "Aviso de sábado sem reserva com duas semanas de antecedência, para dar tempo de virar campanha",
          "Cadastro completo da reserva: nome, WhatsApp, e-mail, cidade, pessoas, ocasião e restrição alimentar",
          "Reserva aberta pela equipe, pela DaIA no site, pelo WhatsApp ou pelo Instagram, com lugares controlados",
          "Catálogo de experiências com preço, duração, lugares e horários, cadastrado pela vinícola",
          "Régua automática de mensagens: confirmação, como chegar, lembrete de véspera e agradecimento",
          "Avisos internos para a equipe: lotação, grupo grande, não comparecimento e resumo do dia",
          "Check-in e visão de quem está na casa agora, com o que cada mesa provou e levou",
    ...
    systemSprints: [
      ...
      {
        number: 4,
        weeks: "Wine Garden · semanas 8 a 10",
        title: "Calendário, reservas e conversão",
        deliverables: [
          "Calendário do mês com ocupação e aviso de dia vazio",
          "Cadastro de reserva com dados do visitante e catálogo de experiências",
          "Régua automática de confirmação, lembrete e pós-visita",
          "Check-in, o que cada mesa provou e o relatório de conversão em venda",
        ],
