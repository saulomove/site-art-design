...
import { ProposalEloIntegracao } from "@/components/proposal-elo/proposal-integracao";
import { ProposalEloMobile } from "@/components/proposal-elo/proposal-mobile";
...
import { ProposalGenyusSafras } from "@/components/proposal-genyus/proposal-safras";
...
import { ProposalGenyusPacotes } from "@/components/proposal-genyus/proposal-pacotes";
...
const GENYUS_NAV: readonly NavItem[] = [
  ...
  { id: "demo", label: "O sistema", desc: "Protótipo navegável — 25 telas para clicar e passear", noDesktop: false },
  { id: "telas", label: "As telas", desc: "Como cada perfil usa o sistema, da balança à diretoria", noDesktop: true },
  { id: "jornada", label: "Um lote", desc: "Do caminhão à garrafa, acompanhando um lote real da sua planilha", noDesktop: true },
